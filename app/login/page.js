  ...
  return (
    <div className="w-full max-w-sm p-4 flex flex-col justify-center mx-auto my-16 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 dark:bg-gray-800 dark:border-gray-700">
      ...
      <p className="text-sm font-normal text-gray-500 dark:text-gray-400 text-center">
        Login to GetMeATea to get support from your fans
      </p>
      <ul className="my-4 space-y-3">
        <li  >
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Continue with Google</span>
        ...
        <li>
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Continue with 
              LinkedIn
            </span>
          </a>
        </li>
        <li>
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Continue with Twitter</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Continue with Facebook</span>
          </a>
        </li>
        <li>
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap" >Continue with GitHub</span>
        ...
        <li>
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Continue with Apple</span>
          </a>
        </li>
      </ul>
      <div>
